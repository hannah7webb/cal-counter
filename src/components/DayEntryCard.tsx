...
export function DayEntryCard({
  ...
  return (
    <div
      ...
      className={`relative touch-pan-y rounded-md cursor-grab active:cursor-grabbing select-none ${
        compact ? 'min-w-0' : ''
      } ${
        isOutsideEatingWindow
          ? 'shadow-[0_0_5px_1px_rgba(244,63,94,0.7)] dark:shadow-[0_0_6px_1px_rgba(251,113,133,0.8)]'
          : ''
      }`}
      {...listeners}
      {...attributes}
