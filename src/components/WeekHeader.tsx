...
import { WeeklyCalorieBar } from './WeeklyCalorieBar';
...
export function WeekHeader({ dates, onPrev, onNext, onToday }: WeekHeaderProps) {
  ...
  return (
    <div className="flex shrink-0 flex-col bg-white dark:bg-black">
      <div className="flex items-center justify-between gap-2 border-b border-neutral-200 px-2 py-2 sm:px-4 sm:py-2.5 dark:border-neutral-800">
